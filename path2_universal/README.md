...
| 檔案 | 說明 | 原始位置 |
|------|------|---------|
| `PATH2_通用模型_做工推薦Pipeline.md` | Pipeline 文件（全面更新至 v4.3） | `General Model_Path2_Construction Suggestion/` |
| `iso_lookup_factory_v4.3.json` | 主查表：130 entries / 292 designs | `General Model_Path2_Construction Suggestion/` |
| `v4_lookup_index.json` | 快速查表索引（從 v4.3 重生成） | `General Model_Path2_Construction Suggestion/` |
| `l1_code_to_v3_mapping.json` | L1 code↔中文部位名（purpose 更新至 v4.3） | `General Model_Path2_Construction Suggestion/` |

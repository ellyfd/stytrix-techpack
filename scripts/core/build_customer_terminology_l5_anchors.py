...
# v2: 擴充 NON_ISO patterns (非縫紉機台 / 沒對應 ISO 的特殊機台)
NON_ISO_MACHINES = [
    r"高速電子打結車|打結車",   # bartack 非縫紉 ISO
    r"手工",                     # 手工工段
    r"整燙|燙工",                # v2 加 燙工
    r"按布機|大鈕扣機|壓襯機",   # v2 加 壓襯機
    r"折邊|烏龍|包邊",
    r"扒縫機",                   # v2 加
    r"褲頭車",                   # v2 加 (specialty 17針 等多針)
    r"六線拷克",                 # v2 加 (no clean ISO equivalent)
]
